<template>
  <DropdownSettingsHeader title="Выбирите нужный язык" @back="$emit('close')" />
  <section class="py-2">
    <ul class="max-h-96 overflow-auto">
      <DropdownSettingsListItem v-for="(languageName, languageId) in languages" :key="languageId" :label="languageName"
